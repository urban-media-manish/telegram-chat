...
app.get('/go', (req, res) => {
  ...
  // Log click for conversion analytics strictly when arriving from genuine Meta Ads
  const isMetaAdClick = !!(fbclid || adId || adName || campaignName || req.query.utm_source);
  if (isMetaAdClick) {
